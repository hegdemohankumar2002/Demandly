...
import {
  ...
  ChevronLeft, ChevronRight, ShieldAlert, MapPin, Settings, Navigation
} from 'lucide-react';
...
const consumerLinks: NavItem[] = [
  ...
  { label: 'Tracking', href: '/consumer/tracking', icon: <Navigation size={20} /> },
...
const manufacturerLinks: NavItem[] = [
  ...
  { label: 'Demand Pools', href: '/manufacturer/demand-pools', icon: <Factory size={20} /> },
  { label: 'My Bids', href: '/manufacturer/my-bids', icon: <FileText size={20} /> },
  { label: 'Propose Product', href: '/manufacturer/propose-product', icon: <Package size={20} /> },
  { label: 'Orders', href: '/manufacturer/fulfilment', icon: <Truck size={20} /> },
  { label: 'Tracking', href: '/manufacturer/tracking', icon: <MapPin size={20} /> },
...
const adminLinks: NavItem[] = [
  ...
  { label: 'Catalog Approvals', href: '/admin/catalog-approvals', icon: <Package size={20} /> },
  { label: 'Orders', href: '/admin/orders', icon: <Truck size={20} /> },
  { label: 'Verifications', href: '/admin/verifications', icon: <ShieldAlert size={20} /> },
